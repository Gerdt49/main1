package Company_v1.Company.company.test;

import Company_v1.Company.company.dao.Company;
import Company_v1.Company.company.dao.CompanyImpl;
import Company_v1.Company.company.model.model.Employee;
import Company_v1.Company.company.model.model.Manager;
import Company_v1.Company.company.model.model.SalesManager;
import Company_v1.Company.company.model.model.Worker;
...
class CompanyImplTest {
    ...
    void addEmployee() {
        ...
        assertEquals(5, company.quantuty()); // теперь в компании 5 сотрудников
    ...
    void removeEmployee() {
        ...
        assertEquals(3, company.quantuty()); // сотрудников стало на 1 меньше (4 - 1)
    ...
    @Test
    void quantityTest() {
        assertEquals(4, company.quantuty());
    ...
    @Test
    void avgSalaryTest() {
        assertEquals( 12100.0 / 4, company.avSalary(), 0.01);
    }
